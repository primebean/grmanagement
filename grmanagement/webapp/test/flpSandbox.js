		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "GR입고관리검수",
									"targetURL": "#syncc201grmanagement-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncc201grmanagement-display": {
								"semanticObject": "syncc201grmanagement",
								"action": "display",
								"description": "gr입고관리",
								"title": "GR입고관리검수",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.c201.grmanagement",
									"url": sap.ui.require.toUrl("sync/c201/grmanagement")
								}
							}
						}
					}
